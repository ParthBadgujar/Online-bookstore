...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Your Number :</span><input type="number" name="number" required placeholder="enter your number">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Pin code :</span>
            <input type="nCmber" min="0" name="pin_code" required placeholder="e.g. 123456">
         </div>
      </div>
